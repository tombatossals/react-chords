...
var getBarreOffset = function getBarreOffset(strings, frets, baseFret) {
  return strings === 6 ? frets[0] === 1 ? baseFret > 9 ? -12 : -11 : baseFret > 9 ? -10 : -7 : frets[0] === 1 ? baseFret > 9 ? -1 : 0 : baseFret > 9 ? 3 : 4;
};

var Neck = function Neck(_ref) {
  var tunning = _ref.tunning,
      frets = _ref.frets,
  ...
  return _react2.default.createElement(
    ...
    !lite && _react2.default.createElement(
      'g',
      null,
      tunning.slice().reverse().map(function (note, index) {
        return _react2.default.createElement(
          'text',
          {
            key: index,
...
Neck.propTypes = {
  tunning: _propTypes2.default.array,
